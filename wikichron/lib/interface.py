...
from .cytoscape_decorator.factory_stylesheet_decorator import construct_decorator_cytoscape_stylesheet
...
def factory_stylesheet_decorator(selected_network_code, stylesheet):
    return construct_decorator_cytoscape_stylesheet(selected_network_code, stylesheet)
