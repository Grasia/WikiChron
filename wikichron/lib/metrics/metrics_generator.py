...
def generate_metrics():
    ...
    metrics.append(Metric('users_active_more_than_4', 'Active users with more than 4 editions', MetricCategory.USERS, stats.users_active_more_than_4, 'Active users who have made more than 4 editions in a month.'))
    metrics.append(Metric('users_active_more_than_24', 'Active users with more than 24 editions', MetricCategory.USERS, stats.users_active_more_than_24, 'Active users who have made more than 24 editions in a month.'))
    metrics.append(Metric('users_active_more_than_99', 'Active users with more than 99 editions', MetricCategory.USERS, stats.users_active_more_than_99, 'Active users who have made more than 99 editions in a month.'))
