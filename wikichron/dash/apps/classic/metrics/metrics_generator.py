...
def generate_metrics():
    ...
    # RATIO
    metrics.append(Metric('edits_per_users_monthly', 'Edits per active users', MetricCategory.RATIOS, stats.edits_per_users_monthly, 'Number of edits for every month per number of active users that month'))
