...
def generate_metrics():
    ...
    metrics.append(Metric('edition_on_type_pages', 'Edits in popular namespaces', MetricCategory.EDITS_ANALYSIS, stats.edition_on_type_pages, 'BAR GRAPH: number of edits in the most popular namespaces of a wiki.'))
    metrics.append(Metric('edition_on_type_pages_extends_rest', 'Edits in other namespaces', MetricCategory.EDITS_ANALYSIS, stats.edition_on_type_pages_extends_rest, 'BAR GRAPH: number of edits in less popular namespaces of the wiki.'))
