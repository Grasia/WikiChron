...
def generate_metrics():
    ...
    metrics.append(Metric('Current_streak', 'Current streak', MetricCategory.BAR, stats.current_streak, 'Users whose current streak of editions is: 1) 1 month. 2) Between 2 and 3 months in a row. 3) Between 4 and 6 months in a row. 4) More than 6 months in a row.'))
    ...
    metrics.append(Metric('users_last_edit', 'Users last edit', MetricCategory.BAR, stats.users_last_edit, 'Users whose last edition was: 0) This month. 1) 1 month ago. 2) Between 2 and 3 months ago. 3) Between 4 and 6 months ago. 4) More than 6 months ago.'))
    ...
    metrics.append(Metric('users_edits_number_of_edits', 'Users number of edits', MetricCategory.BAR, stats.users_number_of_edits, 'Users whose number of editions in a month is: 1) Between 1 and 4 editions. 2) Between 5 and 24 editions. 3) Between 25 and 99 editions. 4) Higher than 99.'))
    metrics.append(Metric('users_edits_number_of_edits_abs', 'Users number of edits_abs', MetricCategory.BAR, stats.users_number_of_edits_abs, ''))
...
# metric 8
    ...
    metrics.append(Metric('type_page_users_edit', 'Users type of edition', MetricCategory.BAR, stats.type_page_users_edit, 'Users who have edited: 1) A main page. 2) A template page. 3) A talk page.'))
