...
def generate_monowiki_metrics():
    ...
    metrics.append(BarGraph('users_edits_number_of_edits_abs', 'Active editors by experience (relative)', MetricCategory.ACTIVE_EDITORS_ANALYSIS, monowiki_stats.users_number_of_edits_abs, 'BAR GRAPH: Users by the number of edits they have made until the previous month (relative).'))
    ...
    metrics.append(BarGraph('number_of_edits_category', 'Edits by editor experience', MetricCategory.EDITS_ANALYSIS, monowiki_stats.number_of_edits_by_category, 'BAR GRAPH: number of editions per categories of active editors by experience.'))
    metrics.append(BarGraph('percentage_of_edits_category', 'Edits by editor experience (relative)', MetricCategory.EDITS_ANALYSIS, monowiki_stats.percentage_of_edits_by_category, 'BAR GRAPH: number of editions per categories of active editors by experience (relative).'))
