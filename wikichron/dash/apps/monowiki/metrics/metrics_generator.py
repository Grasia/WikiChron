...
def generate_classic_metrics():
    ...
    # RATIO
    metrics.append(LineGraph('edits_per_users_monthly', 'Edits per active users', MetricCategory.RATIOS, classic_stats.edits_per_users_monthly, 'Number of edits for every month per number of active users that month', 'Edits per users'))
    metrics.append(LineGraph('edits_in_articles_per_users_monthly', 'Article edits per active user', MetricCategory.RATIOS, classic_stats.edits_in_articles_per_users_monthly, 'Number of edits in articles per number of users for each month', 'Article edits per user'))
