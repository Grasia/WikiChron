...
def generate_metrics():
    ...
    metrics.append(Metric('Current_streak', 'Current streak', MetricCategory.USERS, stats.current_streak, 'Users whose current streak of editions is: 1) 1 month. 2) Between 2 and 3 months in a row. 3) Between 4 and 6 months in a row. 4) More than 6 months in a row.'))
